	...
	<view>
		...
		<view class="profile">
			<view class="profile-row">
				...
				<view @click="toPage('/pages/auth/login')" v-else>未登录</view>
			</view>
			<view class="edit" @click="toPage('/pages/auth/settings')">
		...
		<view class="cards">
			...
			<view class="card actions">
				<view class="cell" v-for="(item, index) in actionsItems" :key="index" @click="toPage(item.path)">
					<view class="cell-row">
...
const actionsItems = [
	{ name: "地址管理", icon: "/static/images/address.png", path: "/pages/address/index"},
	{ name: "客服中心", icon: "/static/images/service.png", path: "" },
	{ name: "设置", icon: "/static/images/settings.png", path: "/pages/auth/settings" },
]
